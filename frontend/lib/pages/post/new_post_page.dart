...
class _NewPostPageState extends State<NewPostPage> {
  ...
  void _savePost() {
    Resource resource = Resource(id: 1, data: base64, name: "new Resource", mimeType: "image/png", size: 13940);
    /**
     * Resource wird erstellt und muss mit der uploadResource Methode an den Server geschickt werden.
     * Man bekommt die id der Resource zurück, welche man dann dem Post Objekt hinzufügt
     */
    Post _post = Post(
      id: 1,
      userID: 1,
